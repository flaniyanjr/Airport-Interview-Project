...
// Filters flight list so that it only shows flights that leave from the corrent airport and are at least 20 min after the previous flight after a flight is added to the rotation list
